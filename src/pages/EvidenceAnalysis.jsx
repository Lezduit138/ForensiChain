        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="text-slate-500">ΓÇó</span>
            ...
            <div className="text-[11px] text-slate-400 font-mono mt-0.5">
              Case: <span className="text-slate-300">{caseData?.firNumber}</span> ΓÇó Storage: {evidence.fileSize} ΓÇó Rec Range: {evidence.recordingStart} &rarr; {evidence.recordingEnd}
            </div>
          </div>
        </div>
